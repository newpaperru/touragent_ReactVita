      ...
      return (
            <div className={styles.card}>
                  <div className={styles.img_wrap}>
                        <img src={imgURL} alt="изображения места" className={styles.img} />
                  ...
                  <div className={styles.container}>
                        <div className={styles.data}>
                              ...
                              <div className={styles.people_wrap}>
                                    ...
                                    <span className={styles.people}>{handlingCountPeople(countPeople)} people going</span>
                              </div>
                        </div>
                        ...
                        <div className={styles.price_wrap}>
                              {discount ? (
                                    <>
                                          <span className={styles.discount} style={{marginRight: 19}}>{Math.round(discountedPrice)} $</span>
                                          <span className={styles.price_line_through}>{price} $</span>
                                    </>
                              ) : (
